...
router.get('/', (_req, res) => {
    res.type('html').send(page('Técnicos en RD', 'Encuentra profesionales locales y administra tus servicios desde Técnicos en RD.', `<h1>Resuelve lo de tu hogar con gente de aquí.</h1>
...
router.get('/terms', (_req, res) => {
    res.type('html').send(page('Términos de uso', 'Términos de uso de la aplicación móvil Técnicos en RD.', `<h1>Términos de uso</h1>
...
router.get('/support', (_req, res) => {
    res.type('html').send(page('Soporte', 'Ayuda y soporte para la aplicación móvil Técnicos en RD.', `<h1>Soporte</h1>
...
router.get('/account-deletion', (_req, res) => {
    ...
    res.type('html').send(page('Eliminación de cuenta', 'Cómo eliminar una cuenta y sus datos de Técnicos en RD.', `<h1>Eliminar tu cuenta</h1>
...
router.get('/reset-password', (req, res) => {
    ...
    res.setHeader('Content-Security-Policy', "default-src 'self'; style-src 'unsafe-inline'; script-src 'unsafe-inline'; connect-src 'self'; base-uri 'none'; form-action 'self'");
    res.type('html').send(page('Restablecer contraseña', 'Crea una nueva contraseña para tu cuenta de Técnicos en RD.', `<h1>Restablecer contraseña</h1>
