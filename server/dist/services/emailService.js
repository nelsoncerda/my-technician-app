    ...
    try {
        ...
        const content = `
            ...
            <p style="margin: 0 0 25px; color: #555; font-size: 16px; line-height: 1.6;">
                Gracias por registrarte en <strong>Técnicos en RD</strong>. Para completar tu registro y acceder a todos los servicios, por favor verifica tu direccion de correo electronico.
            </p>
...
const sendPasswordResetEmail = (email, token, userName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const content = `
            ...
            <p style="margin: 0 0 25px; color: #555; font-size: 16px; line-height: 1.6;">
                Recibimos una solicitud para restablecer la contraseña de tu cuenta en <strong>Técnicos en RD</strong>. Si no hiciste esta solicitud, puedes ignorar este correo.
            </p>

            <div style="text-align: center; margin: 30px 0;">
                <a href="${resetLink}"
                   style="display: inline-block; background: linear-gradient(135deg, #3498db 0%, #2980b9 100%); color: #ffffff; padding: 15px 40px; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: bold; box-shadow: 0 4px 15px rgba(52, 152, 219, 0.3);">
            ...
            <p style="margin: 10px 0 0; word-break: break-all;">
                <a href="${resetLink}" style="color: #3498db; font-size: 13px;">${resetLink}</a>
            </p>
