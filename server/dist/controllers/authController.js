...
const verifyEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const verification = yield prisma_1.default.user.updateMany({
            where: {
                id: user.id,
                emailVerified: false,
                verificationToken: token,
...
const resendVerification = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, emailService_1.sendVerificationEmail)(user.email, newToken, user.name);
        res.json({
...
const forgotPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Send reset email
        yield (0, emailService_1.sendPasswordResetEmail)(user.email, resetToken, user.name);
...
const resetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const reset = yield prisma_1.default.user.updateMany({
            where: {
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (passwordResult.needsRehash) {
            yield prisma_1.default.user.update({
                where: { id: user.id },
                data: { password: yield (0, password_1.hashPassword)(password) },
            });
        }
