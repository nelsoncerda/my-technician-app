...
exports.SERVICE_TYPES = exports.REWARDS = exports.ACHIEVEMENTS = exports.LEVELS = exports.POINT_VALUES = void 0;
...
function pointsToNextLevel(points) {
    ...
    const currentIndex = exports.LEVELS.findIndex((l) => l.levelNumber === currentLevel.levelNumber);
    if (currentIndex < exports.LEVELS.length - 1) {
        const nextLevel = exports.LEVELS[currentIndex + 1];
