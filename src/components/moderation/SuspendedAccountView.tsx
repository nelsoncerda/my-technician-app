  ...
  return (
    <main className="min-h-screen bg-brand-sand px-4 py-10 text-brand-charcoal sm:py-16">
      <section className="mx-auto w-full max-w-2xl rounded-3xl border border-brand-border bg-brand-cream p-6 shadow-soft sm:p-9" aria-labelledby="restricted-account-title">
        <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-danger-50 text-brand-danger-700">
          <ShieldBan className="h-7 w-7" aria-hidden="true" />
        </span>
        <p className="mt-5 text-sm font-bold uppercase tracking-[0.16em] text-brand-danger-700">Acceso restringido</p>
        ...
        {reason && (
          <div className="mt-5 rounded-xl border border-brand-clay-100 bg-brand-clay-50 p-4 text-sm text-brand-clay-700">
        ...
        <div className="mt-8 border-t border-brand-border pt-6">
          ...
          <button
            ...
            onClick={onDelete}
            disabled={deleting}
            className="mt-4 inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-brand-danger-700 px-4 font-bold text-white hover:bg-brand-danger-800 disabled:opacity-60"
          >
